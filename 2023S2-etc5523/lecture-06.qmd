---
title: "Lecture 6: Effective data visualisation"
---
...
library(tidyverse)
library(patchwork)
df <- read_csv(here::here("2023S2-etc5523/data/census-birthplace.csv"))
df2021 <- df %>% 
  filter(census == 2021) %>% 
...
dfsex <- read_csv(here::here("2023S2-etc5523/data/census-birthplace-by-sex.csv")) %>% 
  filter(!birth %in% c("Total")) %>% 
  filter(!birth %in% c("Not Stated", "Other", "Australia")) %>% 
...
<center><img src="images/lecture-06/preattentive-1.svg"/> <img src="images/lecture-06/preattentive-2.svg"/> <img src="images/lecture-06/preattentive-3.svg" class="fragment"/></center>
