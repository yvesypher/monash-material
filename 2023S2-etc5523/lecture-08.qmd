---
title: "Lecture 8: Clearly communicating with code"
---
...
-   It also cannot be a **reserved word**, e.g. `if`, `else`, `TRUE`, `FALSE`, `while`, `function`. 
For full list see [`?Reserved`](https://stat.ethz.ch/R-manual/R-devel/library/base/html/Reserved.html).
...
[Consistency]{.f1 style="color:yellow;"} is key!
